    ...
    fun getMenuSql(){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                viewModel.menulist.add(MenuCollect(location, city, district,
        ...
        if (cursor.moveToFirst()){
            do {
                val values = ContentValues().apply {
                    put("realtime", Gson().toJson(weatherlist[cursor.position].realtime))
                    put("daily", Gson().toJson(weatherlist[cursor.position].daily))
                }
